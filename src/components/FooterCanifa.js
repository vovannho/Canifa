  ...
  return (
    <section className="flex justify-between text-xs text-gray-700 my-8 mx-20 ">
      <section className="w-2/12">
          ...
          <br/>
          <p>Số ĐKKD: 0107574310, ngày cấp: 23/09/2016. Nơi cấp: Sở Kế hoạch và đầu tư Hà Nội
          </p>
          <br/>
      ...
      <section className="w-2/12 pl-20">
        <p className="text-base font-semibold">THƯƠNG HIỆU
        </p>
        <br/>
        <p>Về Canifa
        </p>
        ...
        <p>Chính sách KH thân thiết
        </p>
        <p>Chính sách bảo mật thông tin
        </p>
        <p>Giới thiệu C point
        </p>
      </section>
      <section className="w-3/12">
        <p className="text-base font-semibold ">HỖ TRỢ
        </p>
        <br/>
        <p>FAQs - Hỏi đáp
        </p>
        ...
        <p>Hướng dẫn chọn kích cỡ
        </p>
        <p>Hướng dẫn mua hàng Online
        </p>
        <p>Liên hệ
        </p>
      </section>
      <section className="w-4/12">
        <p className="text-base font-semibold ">ĐĂNG KÝ NHẬN TIN
        </p>
        <br/>
        <div className="flex">
        <input 
