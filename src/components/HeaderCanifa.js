                    ...
                    <Link to="/WomenProductList">
                        ...
                        <div class= {`absolute left-0 w-full  ${showGT===true ? `` : `hidden`}`} style={{paddingTop:'70px'}}>
                            <div className="grid grid-cols-5  pt-2 text-xs px-28 pb-10 bg-white bg-opacity-90 ">
                                ...
                                <ul className="">
                                    <li className="py-4 text-gray-700 font-bold"><a href="" className="">MẶC NHÀ</a></li>
                                    <li><a href="" className="">Bộ mặc nhà</a></li>
                                    <li><a href="" className="">Áo mặc nhà</a></li>
                                    <li><a href="" className="">Quần mặc nhà</a></li>
                                </ul>
                                <ul className="">
                                    <li className="py-4 text-gray-700 font-bold"><a href="" className="">ĐỒ MẶC BÊN TRONG</a></li>
                                ...
                                <ul className="">
                                    <li className="py-4 text-red-600 font-bold"><a href="" className="">TẤT CẢ DƯỚI 149.000đ</a></li>
                                </ul>
                                <ul className="">
                                <img
                        ...
                        <div class={`absolute  w-full left-0 ${showUL2===true ? `` : `hidden`} `}style={{paddingTop:'70px'}}>
                            <div className="grid grid-cols-5  pt-2 px-28 text-xs bg-white bg-opacity-90">
                                ...
                                <ul className="">
                                    ...
                                    <li className="pt-4 text-gray-700 font-bold"><a href="" className="">PHỤ KIỆN</a></li>
                                    <li><a href="" className="">Tất</a></li>
                                    <li><a href="" className="">Phụ kiện khác</a></li>
                                </ul>
                                <ul className="">
                                    <li className="py-4 pb-10 text-red-600 font-bold"><a href="" className="">TẤT CẢ DƯỚI 149.000đ</a></li>
                                </ul>
                                <ul className="">
                                <img
                        ...
                        <div class={`absolute  w-full left-0 ${showUL4===true ? `` : `hidden`} `}style={{paddingTop:'70px'}}>
                            <div className="grid grid-cols-5  pt-2 px-28 text-xs bg-white bg-opacity-90">
                                ...
                                <ul className="">
                                    ...
                                    <li><a href="" className="">Áo mặc nhà</a></li>
                                    <li><a href="" className="">Quần mặc nhà</a></li>
                                    <li className="pt-4 text-gray-700 font-bold"><a href="" className="">LUYỆN TẬP</a></li>
                                    <li><a href="" className="">Áo</a></li>
                                </ul>
                                <ul className="">
                                    <li className="py-4 text-gray-700 font-bold"><a href="" className="">ĐỒ MẶC BÊN TRONG</a></li>
