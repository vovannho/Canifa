...
const WomenProductList = () => {
  ...
  return (
    <section className="max-w-screen-2xl mx-auto ">
      <HeaderCanifa/>
      <p className="px-20 pt-5 text-xs">Trang chủ /Nữ /Danh mục sản phẩm</p> 
      <section className="flex text-xs px-20">
        <section className="w-2/12">
            <ul className="space-y-2 sticky top-20">
              <li className="font-bold mt-5 mb-2 cursor-pointer hover:text-red-600">Nữ</li> 
        ...
        <section className="w-10/12">
            <img
                ...
                src="/assets/images/san-pham-nu-listing.jpg" alt="noload">
            </img>
