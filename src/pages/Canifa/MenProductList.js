...
const MenProductList = () => {
  ...
  //       const products = await apiCodeby.getData("/products", {
  //         search: "sex,man",
  //       });
  ...
  return (
    <section className="max-w-screen-2xl mx-auto">
      ...
      <p className="px-20 pt-5 text-xs cursor-pointer">
        Trang chủ /Nam /Danh mục sản phẩm
      </p>
      <section className="flex text-xs px-20">
        <section className="w-2/12">
          <ul className="space-y-2 sticky top-20">
            <li className="font-bold mt-5 mb-2 hover:text-red-600 cursor-pointer">
              Nam
            </li>
            <Link to="/NewProductMen">
              <li className="font-bold hover:text-red-600 cursor-pointer">
                Sản phẩm mới
              </li>
            </Link>
        ...
        <section className="w-10/12">
          <img
            ...
            src="/assets/images/san-pham-nam.jpg"
            alt="noload"
          ></img>
