...
const NewProductWomen = () => {
  return (
    <section className="max-w-screen-2xl mx-auto">
      <HeaderCanifa/>
      <p className="px-20 pt-5 text-xs">Trang chủ /Nữ /Sản phẩm mới</p> 
      <section className="flex text-xs px-20">
        <section className="w-2/12">
            <ul className="space-y-2 sticky top-20">
              <li className="font-bold mt-5 cursor-pointer hover:text-red-600">Nữ</li> 
        ...
        <section className="w-10/12">
            ...
            <p className="text-center text-gray-700 font-bold text-xl my-3">CÁC MẪU QUẦN ÁO THỜI TRANG NỮ ĐẸP NHẤT</p>
            <p>Với 1000+ mẫu quần áo nữ, CANIFA sẽ giúp bạn thỏa sức lựa chọn và làm mới phong cách cho bản thân. Phái đẹp sẽ tràn đầy tự tin và luôn cảm thấy thoải mái khi diện đồ từ BST thời trang nữ CANIFA do sự đa dạng trong mẫu mã, kiểu dáng cũng như màu sắc...
            </p>
        </section>
      </section>
